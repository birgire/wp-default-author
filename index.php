...
if( ! class_exists( 'Default_Author' ) ):
    ...
    */
    class WP_Default_Author{
        ...
        protected $global_default_author_option_name = 'wpdeau_global_default_author';
        /**
         * Class init
         */
        ...
        <?php }
           ...
           public function show_global_settings() { 
              ...
              register_setting('global_deau', array($this, 'global_default_author_option_name'));
           }
        
           public function global_deau_callback(){
              add_settings_field('global_deau_option', 'Select global default author', array( &$this, 'g_callback'), 'writing', 'global_deau');
           }

           public function g_callback(){
              $options = get_option($this->global_default_author_option_name);
              $global_author = get_option($this->global_default_author_option_name);
              $args = array(
                 'name'               => $this->global_default_author_option_name,
                 'selected'           => $global_author,
